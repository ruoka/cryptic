...
TEST(CrypticSHA256,Reset)
{
    ...
    EXPECT_EQ("16j7swfXgJRpypq8sAguT41WUeRtPNt2LQLQvzfJ5ZI="s, sha256.base64());
    EXPECT_EQ("d7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592"s, sha256.hexadecimal());
}
